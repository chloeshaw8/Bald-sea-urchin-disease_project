...
taxa_silva <- assignTaxonomy(seqtab.nochim, "/DADA2_databases/silva_nr99_v138.1_train_set.fa.gz")
taxa_silva_revcomp <- assignTaxonomy(seqtab.nochim, "/DADA2_databases/silva_nr99_v138.1_train_set.fa.gz", tryRC=TRUE)

taxa_GTDB <- assignTaxonomy(seqtab.nochim, "/DADA2_databases/GTDB_bac-arc_ssu_r86.fa.gz")
taxa_GTDB_revcomp <- assignTaxonomy(seqtab.nochim, "/DADA2_databases/GTDB_bac-arc_ssu_r86.fa.gz", tryRC=TRUE)
...
taxa_silva <- addSpecies(taxa_silva, "/DADA2_databases/silva_species_assignment_v138.1.fa.gz")
taxa_silva_revcomp <- addSpecies(taxa_silva_revcomp, "/DADA2_databases/silva_species_assignment_v138.1.fa.gz")

taxa_GTDB <- addSpecies(taxa_GTDB, "/DADA2_databases/GTDB_dada2_assignment_species.fa.gz")
taxa_GTDB_revcomp <- addSpecies(taxa_GTDB_revcomp, "/DADA2_databases/GTDB_dada2_assignment_species.fa.gz")
